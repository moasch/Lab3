...
public class RoundTile implements GameTile {
     ...
     *
     * @param fillColor the color of the interior of the circle.
     */
     ...
     *
     * @param strokeColor the color of the stroke around the circle.
     * @param fillColor   the color of the interior of the circle.
     */
     ...
     * @param fillColor   the color of the interior of the circle.
     * @param thickness   the thickness of the stroke.
     * @param scale       size of the circle relative to the tile size.
     */
    public RoundTile(final Color strokeColor, final Color fillColor,
